 ...
 */
public class WelfareFirstFragment extends BaseMvpFragment<WelfareContract.View, WelfareContract.Presenter> implements WelfareContract.View, WelfareAdapter.WelfareAdapterListener {
    private RecyclerView mRecyclerView;
    private WelfareAdapter mWelfareAdapter;
    private List<PhotoGirlBean.ResultsBean> mResults;
    private ArrayList<PreviewBean> mPreviewBeanList;

    public WelfareFirstFragment() {
        // Required empty public constructor
    }

    public static WelfareFirstFragment newInstance() {
        WelfareFirstFragment fragment = new WelfareFirstFragment();
        return fragment;
    }
    ...
    private void loadData() {
        mPresenter.loadData(WelfareConstant.URL_WELFARE_1);
    }
    ...
    public void refreshView(final PhotoGirlBean photoGirlBean) {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                ...
                mWelfareAdapter.setOnClickItemListener(WelfareFirstFragment.this);
